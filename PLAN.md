...
- See `PLAN_subtasks.md` for detailed checklists, acceptance criteria and estimates for the top-priority items (reorg-safe indexing, catch-up strategy, metadata redundancy, structured logs, E2E QA).
